...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(41,61,109));
            }
        ...
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(0x6d7fa9)); // color flecha mientras esta seleccionado
            }

            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(41,61,109)); // color flecha
            }
        ...
        txt.setSelectionColor(new Color(41,61,109));
        txt.setBorder(new EmptyBorder(0, 4, 0, 4));
        comboBox.setBackground(new Color(196,205,219));
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    ...
                    label.setBackground(new Color(196,205,219)); // color fondo desplegable
                    label.setForeground(new Color(41,61,109)); // color letra items
                }
                return label;
            }
        };
    ...
    private class ComboSuggestionPopup extends BasicComboPopup {
        ...
        protected Rectangle computePopupBounds(int px, int py, int pw, int ph) {
            ...
            // Ajusta el tamaño del panel desplegable según tus necesidades
            bounds.width = 50; // Cambia este valor según tus necesidades
            bounds.height = 180; // Cambia este valor según tus necesidades
            return bounds;
        }*/
        ...
        protected JScrollPane createScroller() {
            ...
            list.setBackground(new Color(232,235,241));
    ...
    private class ArrowButton extends JButton {
        ...
        public ArrowButton() {
            ...
            setBackground(new Color(41,61,109)); // color de la flecha
        }
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(41,61,109); // ...
        private Color color = new Color(41,61,109); // color del borde
