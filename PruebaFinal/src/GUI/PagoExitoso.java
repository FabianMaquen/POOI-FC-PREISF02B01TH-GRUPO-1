...
public class PagoExitoso extends JFrame {
    private Estudiante usuario;
    private SaldosYPagos ventanaSaldosYPagos;
    
    public PagoExitoso(Estudiante us, SaldosYPagos saldosYPagos) {
        initComponents();
        this.usuario = us;
    ...
    private void initComponents() {
        ...
        panelBlancoCurva.add(jl_resultadoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 110, 392, -1));
        ...
        jl_texto1.setText("Se le enviará la boleta a su correo"); // NOI18N
        ...
        panelBlancoCurva.add(jl_texto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 260, 20));
        jl_texto1.getAccessibleContext().setAccessibleDescription("");

        jl_texto2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jl_texto2.setForeground(new java.awt.Color(41, 61, 109));
        jl_texto2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jl_texto2.setText("Su pago se ha completado correctamente"); // NOI18N
        jl_texto2.setVerticalAlignment(javax.swing.SwingConstants.TOP);
    ...
    private javax.swing.JLabel jl_texto2;
